  ...
  return (
    <div className="container mt-10 pt-10 mx-auto p-6">
      ...
      <div className="mt-10 bg-gray-300 rounded-lg">
        <h2 className="text-2xl font-bold mb-4 text-center bg-gray-400 rounded-lg text-white">Rate and Comment</h2>
        {submitted ? (
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            <div className="mb-4">
              <label
                htmlFor="rating"
                className="block text-gray-100 font-semibold mb-2 ml-5"
              >
                Rating (1 to 10):
              </label>
              <select
