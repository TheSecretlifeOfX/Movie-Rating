  ...
  return (
    <div className="container mt-10 pt-10 mx-auto p-6">
      ...
      <div className="mt-10 bg-gray-300 rounded-lg">
        <h2 className="text-2xl font-bold mb-4 text-center bg-gray-400 rounded-lg">Rate and Comment</h2>
        {submitted ? (
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              ...
              className="bg-gray-500 text-white px-6 py-2 rounded hover:bg-gray-400 items-align-center"
            >
              Submit
            </button>
          </form>
