...
const MoviesListPage = () => {
  ...
  const searchQuery = searchParams.get("search") || ""; // Get the 'search' parameter from the URL
        ...
        <div>
          ...
          <div className="flex justify-center items-center mt-8 space-x-4">
            ...
            <button
              ...
              className={`px-6 py-2 rounded-full ${currentPage === totalPages ? "bg-gray-300 text-gray-500 cursor-not-
